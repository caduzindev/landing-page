...
__webpack_require__(/*! ./caroulsels */ "./resources/js/caroulsels.js");

__webpack_require__(/*! ./sendMailUser */ "./resources/js/sendMailUser.js");
...
function IdentifyTrActive() {
  var trs = document.querySelectorAll('tr[data-status]');
...
function sendStatusOfCaroulseul(e) {
  ...
  fetch("/caroulsel/status/".concat(id), {
    method: 'GET'
...
window.onload = function () {
  ...
  IdentifyTrActive();
  var buttonsTrs = document.querySelectorAll('.first-button');
  buttonsTrs.forEach(function (e) {
